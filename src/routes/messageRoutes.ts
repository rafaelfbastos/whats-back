...
messageRoutes.get("/api/messages/status", tokenAuth, MessageController.status);
messageRoutes.post("/api/whatsapp/qrcode", tokenAuth, MessageController.reconnectAndGetQrCode);
